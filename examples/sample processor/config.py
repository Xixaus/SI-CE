...
class ProcessorConfig:
    ...
    excel_file_path: str = "final_program.xlsx"
    ...
    # Batch parameters - SEPARATE SPEEDS FOR MeOH AND DI
    initial_batch_size: int = 3
    batch_fill_speed_meoh: int = 1000  # µL/min for MeOH
    batch_fill_speed_di: int = 1200    # µL/min for DI water
    ...
    log_to_console: bool = False  # Changed to True for better overview

    # Other settings
    show_progress_bars: bool = True
    verbose_chemstation: bool = False
    verbose_SI_method: bool = True
    detailed_logging: bool = True  # New parameter for detailed logging
